...
import SupportUsLinks from "../support-us/links";
  ...
  {/* Top decorative element */}
		<div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-emerald-400 to-teal-400"></div>
			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-col lg:flex-row lg:justify-center gap-32 lg:gap-16 mb-12 mt-16 max-w-md lg:max-w-none">
					{/* Contact info */}
